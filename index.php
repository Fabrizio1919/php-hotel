    ...
    <header>
        <nav class="navbar bg-dark" data-bs-theme="dark">
            <div class="container-fluid">
                <div class="navbar-brand fs-1 fw-bold text-light">Hotel</div>
            </div>
        </nav>
    </header>


    <div class="card text-bg-dark m-3 shadow">
        ...
        <form class=" card-header fs-4 row gx-5 mx-4 mt-3" method="GET">
            ...
            <div class="form-check form-switch col-auto ">
                <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" name="parking" value="true">
